...
if TYPE_CHECKING:
    ...
    from .lm_commands_cfg import LMTerrainBasedPose2dCommandCfg, LMUniformPose2dCommandCfg


class LMUniformPose2dCommand(CommandTerm):
    ...
    cfg: LMUniformPose2dCommandCfg
    """Configuration for the command generator."""

    def __init__(self, cfg: LMUniformPose2dCommandCfg, env: ManagerBasedEnv):
...
class LMTerrainBasedPose2dCommand(LMUniformPose2dCommand):
    ...
    cfg: LMTerrainBasedPose2dCommandCfg
    """Configuration for the command generator."""

    def __init__(self, cfg: LMTerrainBasedPose2dCommandCfg, env: ManagerBasedEnv):
        # initialize the base class
        super().__init__(cfg, env)
