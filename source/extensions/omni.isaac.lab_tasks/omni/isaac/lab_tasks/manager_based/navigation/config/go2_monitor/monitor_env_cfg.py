...
class ActionsCfg:
    ...
    pre_trained_policy_action: mdp.PreTrainedPolicyActionCfg = mdp.PreTrainedPolicyActionCfg(
        ...
        policy_path="/home/daojie/isaac_lab/IsaacLab/logs/rsl_rl/unitree_go2_flat/2024-10-25_22-16-40/exported/policy.pt",
...
@configclass
class MonitorEnvCfg(ManagerBasedRLEnvCfg):
...
class MonitorEnvCfg_PLAY(MonitorEnvCfg):
